    ...
    time--;
               ...
               <form id="myform" action="controller.jsp">
					...
					<div class="question-panel">
						...
						<div class="answer">
							<input type="radio"  name="ans<%=i%>" value="<%=question.getOpt1()%>"/>
							<label><%=question.getOpt1()%></label>
							<input type="radio" name="ans<%=i%>" value="<%=question.getOpt2()%>" />
							<label><%=question.getOpt2()%></label>
							<input type="radio" name="ans<%=i%>" value="<%=question.getOpt3()%>" />
							<label><%=question.getOpt3()%></label>
							<input type="radio"  name="ans<%=i%>" value="<%=question.getOpt4()%>"/>
							<label><%=question.getOpt4()%></label>
